...
$('.all-icon').click(function(){
  setTimeout(() => {
    $('.web-design').fadeOut(300);
    $('.web-apps').fadeOut(300);
    $('.mobile-apps').fadeOut(300);
    $('.desktop').fadeOut(300);
    $('.web-design-icon').removeClass('btn-active');
    $('.web-apps-icon').removeClass('btn-active');
    $('.mobile-apps-icon').removeClass('btn-active');
    $('.desktop-icon').removeClass('btn-active');
  }, 100);
  setTimeout(() => {
    $('.all').fadeIn(400);
    $('.all-icon').addClass('btn-active');
  }, 400);
})

$('.web-design-icon').click(function(){
  setTimeout(() => {
    $('.all').fadeOut(300);
    $('.web-apps').fadeOut(300);
    $('.mobile-apps').fadeOut(300);
    $('.desktop').fadeOut(300);
    $('.all-icon').removeClass('btn-active');
    $('.web-apps-icon').removeClass('btn-active');
    $('.mobile-apps-icon').removeClass('btn-active');
    $('.desktop-icon').removeClass('btn-active');
  }, 100);
  setTimeout(() => {
    ...
    $('.web-design-icon').addClass('btn-active');
  }, 400);
})

$('.web-apps-icon').click(function(){
  setTimeout(() => {
    $('.all').fadeOut(300);
    $('.web-design').fadeOut(300);
    $('.mobile-apps').fadeOut(300);
  ...
  setTimeout(() => {
    $('.web-apps').fadeIn(400);
    $('.web-apps-icon').addClass('btn-active');
  }, 400);
})

$('.mobile-apps-icon').click(function(){
  setTimeout(() => {
    $('.all').fadeOut(300);
    $('.web-design').fadeOut(300);
    $('.web-apps').fadeOut(300);
  ...
  setTimeout(() => {
    $('.mobile-apps').fadeIn(400);
    $('.mobile-apps-icon').addClass('btn-active');
  }, 400);
})
...
$('.desktop-icon').click(function(){
  ...
  setTimeout(() => {
    $('.desktop').fadeIn(400);
    $('.desktop-icon').addClass('btn-active');
  }, 400);
})
...
$('.cloud').mouseover(function(){
  setTimeout(() => {
    ...
    $('.tag-word').fadeOut(300);
    $('.eye').removeClass('bg-blue text-white');
    $('.dash').removeClass('bg-blue text-white');
    $('.tag').removeClass('bg-blue text-white');
  }, 100);
  setTimeout(() => {
    $('.cloud-word').fadeIn(400);
    $('.cloud').addClass('bg-blue text-white');
  }, 400);
})
...
$('.dash').mouseover(function(){
  setTimeout(() => {
    ...
    $('.tag-word').fadeOut(300);
    $('.eye').removeClass('bg-blue text-white');
    $('.cloud').removeClass('bg-blue text-white');
    $('.tag').removeClass('bg-blue text-white');
  }, 100);
  setTimeout(() => {
    $('.dash-word').fadeIn(300);
    $('.dash').addClass('bg-blue text-white');
  }, 400);
})
...
$('.eye').mouseover(function(){
  ...
  setTimeout(() => {
    $('.eye-word').fadeIn(300);
    $('.eye').addClass('bg-blue text-white');
  }, 400);
})
...
$('.tag').mouseover(function(){
  ...
  setTimeout(() => {
    $('.tag-word').fadeIn(300);
    $('.tag').addClass('bg-blue text-white');
  }, 400);
})
